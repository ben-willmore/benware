function grid = grid_noise_with_WhiskandLight()
  ...
  no_light_no_whisk_condition=createPermutationGrid(800, 500, 50, whiskvoltages(1), 100, 50, lightvoltages(1), 100, 50, 80);% normnally sweep is 1250ms
  ...
  %lighttrain_condition=createPermutationGrid(1500, 500, 100, voltages(2), 1, 10, levels);
   ...
   light_grid=createPermutationGrid(800, noise_delay, 50, whiskvoltages(1), 100,50, lightvoltages(2), 100,50, levels);% normnally sweep is 1250ms
   whisk_grid=createPermutationGrid(800, noise_delay, 50, whiskvoltages(2), 100,50, lightvoltages(1), 100,50, levels);% normnally sweep is 1250ms
   whiskandlight_grid=createPermutationGrid(800, noise_delay, 50, whiskvoltages(2), 100,50, lightvoltages(2), 100,50, levels);% normnally sweep is 1250ms
