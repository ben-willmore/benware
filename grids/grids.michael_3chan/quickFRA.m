function grid = grid_tone_with_light()
  ...
  %control conditions
  no_whisk_no_light_condition=createPermutationGrid(550, freqs, 100, 100,whiskvoltages(1), 100, 50, lightvoltages(1), 100, 50, level);% 550ms length ()100ms duration tones) %normally sweep length 550
