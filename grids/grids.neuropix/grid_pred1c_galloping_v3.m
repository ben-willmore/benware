function grid = grid_pred1c_galloping_v3()

% controlling the sound presentation
grid.sampleRate = tdt100k;
grid.stimGenerationFunctionName = 'stimgen_loadSoundFile';
grid.stimDir = 'e:\benware.sounds.uncalib\pred1c_galloping_v3\';
grid.stimFilename = 'pred1c_galloping.type%1.set%2.n%3.wav';
