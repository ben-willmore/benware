function stim = stimgen_st_sequencelearning_vowel_with_noise(expt, grid, varargin)
...
% audiowrite('e:\auditory-objects\benware\benware\stimgen\st_sequencelearning_D\st_sequencelearning_D_EXCD.wav',stim',floor(sampleRate));
